 ...
 */
class StatusUpdate {
  @Agent(description = "Update application status based on score") def update(@V("combinedCvReview") aggregateCvReview: CvReview): Unit = {
    val score = aggregateCvReview.score

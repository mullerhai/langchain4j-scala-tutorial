...
import dev.langchain4j.http.client.spring.restclient.{SpringRestClientBuilder, SpringRestClientBuilderFactory}
...
object McpGithubToolsExample {
   ...
   * <p> System.getenv("OPENAI_API_KEY")  modelName("gpt-4o-mini"
